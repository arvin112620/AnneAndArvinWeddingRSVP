...
const folder = '/prenup-photos';
const photos = ['DSC00727.jpg', 'DSC00732.jpg', 'DSC00815.jpg', 'DSC00824.jpg', 'DSC00886.jpg', 'DSC00890.jpg', 'DSC00898.jpg', 'DSC00949.jpg'];

type PublicImageProps = React.ImgHTMLAttributes<HTMLImageElement> & { fill?: boolean; priority?: boolean; sizes?: string };
...
const palette = [
  ...
  { name: 'Beige', color: '#e6dfcc', text: 'text-ink' },
  { name: 'Cream', color: '#fff3d4', text: 'text-ink' },
];
